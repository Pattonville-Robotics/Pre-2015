...
void alignWithColumn(int value)
{
	...
	{
		turnToAngle(40, 0, 45);
		goStraightForTime(2250, 40, 45);//This has been 2250, 2300, and 2400 based on battery level. Do something about it each time.
		turnToAngle(40, 0, 0);
		goStraightUntilIRNothing(40);
		goStraightForTime(500, 30, 0);
		turnToAngle(40, 0, 0);
...
task main()//Main task. Execution starts here.
{
	...
	goStraightForTime(1500, 64, 0);
	motor[leftmotor]=0;
	motor[rightmotor]=0;
	wait10Msec(100);
	determineColumn();
	goStraightForTime(200, 40, 0);
	motor[leftmotor]=0;
	motor[rightmotor]=0;
