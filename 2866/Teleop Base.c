...
#pragma config(Motor,  mtr_S1_C2_2,     rightArmMotor,        tmotorTetrix, openLoop, reversed)
...
//if(joystick.joy1_TopHat == 0)  this is out of the task main until another can apply this
//    {
