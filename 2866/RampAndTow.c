...
void getOffRamp()
{
	writeDebugStreamLine("Beginning autonomous routine.");
    
	driveWithGyro(0, -30);
	wait1Msec(10000);
    
	writeDebugStreamLine("Exited ramp, beginning turn.");
	...
	writeDebugStreamLine("Turned 180 degrees");
...
void beginTowing()
{
    writeDebugStreamLine("Locking servo for bucket.")
	servo[lockServo] = 50;
...
void knockDownPole()
{
    //DriveForTime, maybe slight turn once close.
}
    
void park()
{
    //Turn and correct bearings.
    //Drive forward for time.
}
